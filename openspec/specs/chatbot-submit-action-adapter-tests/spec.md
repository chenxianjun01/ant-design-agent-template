# chatbot-submit-action-adapter-tests Specification

## Purpose
TBD - created by archiving change chatbot-submit-action-adapter-validation. Update Purpose after archive.
## Requirements
